          ...
          >
            ...
            <form onSubmit={handleSubmit} className="grid gap-4 py-4">
              <div className="grid gap-2">
                <Label htmlFor="name" className="text-zinc-300">Property Name</Label>
                <Input
                  id="name"
                  required
                  value={formData.name}
              ...
              <div className="grid gap-2">
                <Label htmlFor="price" className="text-zinc-300">Monthly Rent (Rp)</Label>
                <Input
                  id="price"
                  type="number"
                  required
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                <Label className="text-sm cursor-pointer text-zinc-300" onClick={() => setFormData({ ...formData, available: !formData.available })}>
                  Available for rent
                </Label>
              </div>
