  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" className="relative h-10 w-10 rounded-full p-0 ring-offset-background transition-all hover:ring-2 hover:ring-primary-500/20">
      ...
      <DropdownMenuContent className="w-56 glass border-white/10 bg-white/5 p-2 backdrop-blur-xl" align="end" forceMount>
